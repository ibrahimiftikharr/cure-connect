            ...
            appointments.map(appointment => (
              ...
              >
                ...
                <div className="px-4 pb-4 pt-2 flex flex-col items-center text-center">
                  ...
                  <div className="w-16 h-16 rounded-xl bg-white shadow-lg border border-gray-200 p-0.5 mb-3">
                    {appointment.patientInfo?.profilePicture ? (
                      <img 
                        ...
                        alt={appointment.patientInfo.name || 'Patient'}
                        className="w-full h-full rounded-xl object-cover"
                      />
                    ) : (
                      <div className="w-full h-full rounded-xl bg-gradient-to-br from-purple-100 to-pink-100 flex items-center justify-center text-2xl font-bold text-purple-600">
                        {appointment.patientInfo?.name?.charAt(0)?.toUpperCase() || 'P'}
                      </div>
                    )}
                  </div>
                  ...
                  <p className="text-purple-600 font-medium text-xs mb-3">Patient</p>
                  ...
                  <div className="space-y-2 mb-3 w-full">
                    ...
                    <div className="px-3 py-2 bg-purple-50 rounded-lg">
                      <span className="text-xs font-bold text-purple-700">{appointment.timeSlot}</span>
                    </div>
                  </div>
                  ...
                  {appointment.status === 'pending' && (
                    <div className="grid grid-cols-2 gap-2 w-full">
                      <button 
                        ...
                        className="px-3 py-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg hover:shadow-lg transition-all text-xs font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                      ...
                      <button 
                        ...
                        disabled={processingId === appointment._id}
                        className="px-3 py-2 bg-gradient-to-r from-red-600 to-rose-600 text-white rounded-lg hover:shadow-lg transition-all text-xs font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        Reject
                      </button>
                    </div>
